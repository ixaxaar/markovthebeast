...
public final class TestReflectiveVisitor {
    ...
    /**
     * A test implementation of the ReflectiveIterator. Eats all fruits, peels oranges before.
     */
    public final class Eater extends ReflectiveVisitor<Fruit> {
        ...
        /**
         * Peels the orange and eats it afterwards. Needs to be annotated in order to be found by this visit method.
         *
