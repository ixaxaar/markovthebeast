...
/**
 * A NestedSubstitution is a substitution of variables (the outer substitution)
 * that contains a nested set of substitutions (the inner substitutions). It can
...
public final class NestedSubstitution {
  ...
  /**
   * Two NestedSubstitution are equal if the outer substitutions are equal and
   * the collections of inner substitutions too.
   *
  ...
  /**
   * Returns a hashcode based on the outer substitution and the collection of
   * inner substitutions.
   *
