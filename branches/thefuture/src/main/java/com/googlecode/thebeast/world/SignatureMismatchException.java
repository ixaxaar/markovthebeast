...
/**
 * Many methods and classes require matching signatures for the objects it
 * proceses or contains. This method is thrown when signatures do not match,
 * e.g. if a predicate for a signature is to be created with types from a
 * different signature.
 *
