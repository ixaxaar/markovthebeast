...
/**
 * A SQLTableDescription describes an SQL table that is used for storing FOL
 * constant tuples. It provides the name of the table, the names of the columns
 * and the corresponding FOL type for each column.
 *
...
final class SQLTableDescription {
   ...
   * @param columnNames the list of column names corresponding to the tuple
   *                    argument indices.
   */
   ...
   *
   * @return A list of SQL representable FOL types, where the type at index i
   *         describes the type of constants at tuple position i.
   */
  ...
  /**
   * Return the name of column that represents the constant at tuple index
   * argIndex.
   *
