...
predicate aligndown: Int x Int;
predicate alignright: Int x Int;
predicate aligndiag: Int x Int;
predicate aligninv: Int x Int;
...
hidden: align,aligndiag,aligndown,alignright,aligninv;
...
auxiliary: aligndiag, aligndown, alignright,aligninv;
...
include "chi-eng-quad-bias.pml";
include "chi-eng-quad-m1.pml";
include "chi-eng-quad-reldist.pml";
include "chi-eng-quad-word.pml";
include "chi-eng-quad-dict.pml";
include "chi-eng-quad-pos.pml";
...
//align -> quadratic align
factor [2]: for Int s, Int t if source(s,_) & target(t,_) & target(t+1,_) & s > 0 & t > 0:
  align(s,t) & align(s,t+1) => aligndown(s,t);

factor [2]: for Int s, Int t if source(s,_) & source(s+1,_) & target(t,_) & s > 0 & t > 0:
  align(s,t) & align(s+1,t) => alignright(s,t);

factor [2]: for Int s, Int t if source(s,_) & source(s+1,_) & target(t,_) & target(t+1,_) & s > 0 & t > 0:
  align(s,t) & align(s+1,t+1) => aligndiag(s,t);

factor [2]: for Int s, Int t if source(s,_) & source(s-1,_) & target(t,_) & target(t-1,_) & s > 1 & t > 0:
  align(s,t) & align(s-1,t+1) => aligninv(s,t);


//quadratic align -> align
factor [2]: for Int s, Int t if source(s,_) & target(t,_) & target(t+1,_) & s > 0 & t > 0:
  aligndown(s,t) => align(s,t);

factor [2]: for Int s, Int t if source(s,_) & target(t,_) & target(t+1,_) & s > 0 & t > 0:
  aligndown(s,t) => align(s,t+1);

factor [2]: for Int s, Int t if source(s,_) & source(s+1,_) & target(t,_) & s > 0 & t > 0:
  alignright(s,t) => align(s,t);

factor [2]: for Int s, Int t if source(s,_) & source(s+1,_) & target(t,_) & s > 0 & t > 0:
  alignright(s,t) => align(s+1,t);

factor [2]: for Int s, Int t if source(s,_) & source(s+1,_) & target(t,_) & target(t+1,_) & s > 0 & t > 0:
  aligndiag(s,t) => align(s,t);

factor [2]: for Int s, Int t if source(s,_) & source(s+1,_) & target(t,_) & target(t+1,_) & s > 0 & t > 0:
  aligndiag(s,t) => align(s+1,t+1);

factor [2]: for Int s, Int t if source(s,_) & source(s-1,_) & target(t,_) & target(t+1,_) & s > 1 & t > 0:
  aligninv(s,t) => align(s,t);

factor [2]: for Int s, Int t if source(s,_) & source(s-1,_) & target(t,_) & target(t+1,_) & s > 1 & t > 0:
  aligninv(s,t) => align(s-1,t+1);
