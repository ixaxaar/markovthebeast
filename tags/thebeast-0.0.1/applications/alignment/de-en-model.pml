...
predicate targethead: Int x Int;
predicate targetdep: Int x TargetDep;
predicate sourcehead: Int x Int;
predicate sourcedep: Int x SourceDep;
...
predicate srctotalprob: Int x Double;
predicate tgttotalprob: Int x Double;
predicate sourcedom: Int x Int;
predicate targetdom: Int x Int;
...
observed: source, target, reldist, srcchar, tgtchar, srccount, tgtcount, targetpos, targetchunk,
  ...
  srcm1ranks, tgtm1ranks,sourcepos, wordToWord, wordToChar, charToWord, charToChar, targethead,
  targetdep, sourcehead, sourcedep, srctotalprob, tgttotalprob,sourcedom, targetdom;

include "de-en-real.pml";
//include "de-en-pos.pml";
//include "de-en-dict.pml";
//include "de-en-local-markov.pml";
include "de-en-dep.pml";
//include "de-en-markov.pml";
