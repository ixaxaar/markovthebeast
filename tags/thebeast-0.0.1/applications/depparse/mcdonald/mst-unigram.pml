...
// additional labelled features
//h_pos_m1_pos
weight h_pos_m1_pos : Pos x Pos x Dep -> Double;
factor:
  for Int h, Int m, Pos h_pos, Dep l, Pos h_p_m1
  if pos(h,h_pos) & pos(h-1,h_p_m1) & word(m,_)
  add [dep(h,m,l)] * h_pos_m1_pos(h_pos, h_p_m1, l);

//h_pos_p1_pos
weight h_pos_p1_pos : Pos x Pos x Dep -> Double;
factor:
  for Int h, Int m, Pos h_pos, Dep l, Pos h_p_p1
  if pos(h,h_pos) & pos(h+1,h_p_p1) & word(m,_)
  add [dep(h,m,l)] * h_pos_p1_pos(h_pos, h_p_p1, l);

//h_pos_m1p1_pos
weight h_pos_m1p1_pos : Pos x Pos x Pos x Dep -> Double;
factor:
  for Int h, Int m, Pos h_pos, Dep l, Pos h_p_p1, Pos h_p_m1
  if pos(h,h_pos) & pos(h+1,h_p_p1) & word(m,_) & pos(h-1,h_p_m1)
  add [dep(h,m,l)] * h_pos_m1p1_pos(h_pos, h_p_p1, h_p_m1, l);
