 ...
 */
public class MemDoubleTimes extends AbstractMemExpression<DoubleType> implements DoubleTimes {

  private DoubleExpression leftHandSide, rightHandSide;

  public MemDoubleTimes(DoubleType type, DoubleExpression leftHandSide, DoubleExpression rightHandSide) {
    super(type);
