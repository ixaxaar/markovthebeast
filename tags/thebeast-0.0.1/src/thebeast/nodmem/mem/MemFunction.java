...
public final class MemFunction {
  ...
  public enum Type {
    ...
    RELATION_SELECTOR, RELATION_SELECTOR_NO_UNIFY, CONTAINS,
    INT_POST_INC, ARRAY_ACCESS_ZERO, ARRAY_CREATOR,
    GROUP, INDEXED_SUM,
    ...
    DOUBLE_GEQ, DOUBLE_LT, DOUBLE_DIVIDE, INT_MIN, DOUBLE_ABS, INDEX_COLLECTOR
