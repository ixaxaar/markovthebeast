...
public class Signature {
	 ...
	 * @param withUnknowns
	 *            if true the types matches unknown strings to a designated
	 *            UNKNOWN constant.
	 * @param constants
	 ...
	 * 
	 * @param name
	 *            the name of the weight function
	 * @param argumentTypes
	 *            the list of argument types
	 * @return a weight function with the given signature
	 */
	public WeightFunction createWeightFunction(String name,
	 ...
	 *            the name of the weight function
	 * @param positive
	 *            if true the weight function will only map to non-negative
