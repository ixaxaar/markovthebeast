...
predicate alignsrcpair: Int x Int;
predicate aligntgtpair: Int x Int;
...
factor[1]: for Int s1, Int s2, Int t if source(s1,_) & source(s2,_) & target(t,_) & s2 > s1:
  align(s1,t) & align(s2,t) => alignsrcpair(s1,s2);

factor[1]: for Int s1, Int s2, Int t if source(s1,_) & source(s2,_) & target(t,_) & s2 > s1:
  align(s1,t) & alignsrcpair(s1,s2) => align(s2,t);

factor[1]: for Int s1, Int s2, Int t if source(s1,_) & source(s2,_) & target(t,_) & s2 > s1:
  align(s2,t) & alignsrcpair(s1,s2) => align(s1,t);

//make pairs and alignment consistent
factor[1]: for Int t1, Int t2, Int s if target(t1,_) & target(t2,_) & source(s,_) & t2 > t1:
  align(s,t1) & align(s,t2) => aligntgtpair(t1,t2);

factor[1]: for Int t1, Int t2, Int s if target(t1,_) & target(t2,_) & source(s,_) & t2 > t1:
  align(s,t1) & aligntgtpair(t1,t2) => align(t2,s);

factor[1]: for Int t1, Int t2, Int s if target(t1,_) & target(t2,_) & source(s,_) & t2 > t1:
  align(s,t2) & aligntgtpair(t1,t2) => align(t1,s);
