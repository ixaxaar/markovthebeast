...
public class TestMemEvaluator extends TestCase {
  ...
  protected void setUp() {
    ...
    MemChunk argHolder = new MemChunk(1,1,3,0,0);
  ...
  public void testAdd() {
    ...
    MemChunk chunk1 = new MemChunk(1, 1, new MemDim(1, 0, 0));
    MemChunk chunk2 = new MemChunk(1, 1, new MemDim(2, 0, 0));

    chunk1.intData[0] = 2;
    chunk2.intData[1] = 3;

    MemChunk dst = new MemChunk(1, 1, new MemDim(1, 0, 0));
  ...
  public void testTupleSelector() {
    MemChunk dst = new MemChunk(1,1,0,0,1);
  ...
  public void testRelationSelector(){
    MemChunk dst = new MemChunk(1,1,0,0,1);
    MemChunk argHolder = new MemChunk(1,1,0,0,3);
