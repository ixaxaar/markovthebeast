...
try:                                
    opts, args = getopt.getopt(sys.argv[1:],"vhrGSHLTO:s:o:d:b:t:M:5:6:7:8:f:",["verbose","splits=",
        "output=","def=","strict","open=","begin=","total=","randomize","help","test","conll05=","conll06=","conll08=","conll07=","possible_ON","possible=","preds_list=","s1","s2","s3","per_predicate","mst_conll08",
