...
weight l_role_lp_la: Lemma x Lemma x Role -> Double;
factor: for Int p, Int a, Lemma l_p, Lemma l_a ,Role r if lemma(p,l_p) & lemma(a,l_a)
...
weight l_role_lp_pa: Lemma x Ppos x Role -> Double;
factor: for Int p, Int a, Lemma l_p, Ppos p_a ,Role r if lemma(p,l_p) & ppos(a,p_a)
...
weight l_role_pp_la: Ppos x Lemma x Role -> Double;
factor: for Int p, Int a, Ppos p_p, Lemma l_a ,Role r if ppos(p,p_p) & lemma(a,l_a)
