...
factor: for Int a, Int p, Role r, Lemma lp, MPathFrameUnlabeled pathFrame
  if m_path_frame_unlabeled(p,a,pathFrame) & lemma(p,lp) &
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
...
factor: for Int a, Int p, Role r, Lemma la, MPathFrameUnlabeled pathFrame
  if m_path_frame_unlabeled(p,a,pathFrame) & lemma(a,la) &
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
...
factor: for Int a, Int p, Role r, MPathFrame pathFrame, Lemma lp, Lemma la
  if m_path_frame(p,a,pathFrame) & lemma(p,lp) & lemma(a,la) & 
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
...
factor: for Int a, Int p, Role r, MPathFrame pathFrame, Postfix lp, Postfix la
  if m_path_frame(p,a,pathFrame) & postfix(p,lp) & postfix(a,la) &
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
...
factor: for Int a, Int p, Role r, MPathFrame pathFrame, Lemma l if m_path_frame(p,a,pathFrame) & lemma(a,l) &
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
...
factor: for Int a, Int p, Role r, MPathFrame pathFrame, Lemma l, Voice v if m_path_frame(p,a,pathFrame) &
  lemma(p,l) & voice(p,v) &
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
...
factor: for Int p, Int a, MDependency d, Voice v, Role r if voice(p,v) & m_dep(_,a,d) &
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
...
factor: for Int p, Int a, MDependency d, Role r if m_dep(_,a,d) &
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
...
factor: for Int p, Int a, MDependency da, MDependency dp, Role r if m_dep(_,a,da) & m_dep(_,p,dp) &
  possiblePredicate(p) & possibleArgument(a) &
  palmer(p,a)
