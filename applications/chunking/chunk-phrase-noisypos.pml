...
factor:
  ...
  if noisypos(b,_) & noisypos(e,_) & e >= b + 1 & m >= b & m <= e & noisypos(m,w1) & noisypos(m+1,w2)
...
factor:
  ...
  if noisypos(b,_) & noisypos(e,_) & e >= b + 2 & m >= b & m <= e & noisypos(m,w1) & noisypos(m+1,w2) & noisypos(m+2,w3)
