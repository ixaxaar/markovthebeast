...
/**
 * This exception is thrown when a client attempts to assign a parent world for
 * a particular predicate but there is already a relation for the predicate in
 * use. This could cause inconsistencies (when one clients changes the local
