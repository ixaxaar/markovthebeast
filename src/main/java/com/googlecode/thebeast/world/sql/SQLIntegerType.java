...
class SQLIntegerType extends SQLRepresentableType
     ...
     * @return the integer constant corresponding to the integer value represented by the given string.
     * @throws ConstantNameNotInTypeException if <code>name</code> is not an string that represents an integer.
     */
