...
class SQLDoubleConstant extends SQLRepresentableConstant
    ...
    /**
     * Creates a new SQLIntegerConstant with the given value and belonging to the given type.
     *
    ...
    /**
     * Return true iff this and the other object are both SQLDoubleConstant objects and represent the same double value.
     *
     * @param o the other symbol.
     * @return true iff both objects are SQLDoubleConstant objects representing the same value.
     */
    @Override
