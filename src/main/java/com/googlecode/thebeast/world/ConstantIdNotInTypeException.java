...
/**
 * This Exception is is thrown when a type is queried for a constant with an id
 * but there is no constant with the given id in the type.
 *
...
public final class ConstantIdNotInTypeException extends RuntimeException {
  ...
  /**
   * Returns an integer value that was used to request a constant from the given
   * type.
   *
