...
% SR: I removed the part with the new heuristic, because it wasn't really clear to me what was done, and when.

% are made during sense disambiguation. In Czech the sense of a predicate 
% there was no sense g
% the name of the corpus did not   
...
%In particular the predicate, \emph{být} which has $54$ possible frames was the 
