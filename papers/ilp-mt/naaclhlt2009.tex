...
\title{Instructions for NAACL HLT 2009 Proceedings\Thanks{This document has been adapted from the instructions for 
...
for publication in the NAACL HLT 09 proceedings.  All authors are required
...
NAACL HLT provides this description in \LaTeX2e{} ({\tt naaclhlt2009.tex}) and PDF
format ({\tt naaclhlt2009.pdf}), along with the \LaTeX2e{} style file used to
format it ({\tt naaclhlt2009.sty}) and an ACL bibliography style ({\tt naaclhlt2009.bst}).
These files are all available at
{\tt http://www.naaclhlt2009.org}.  A Microsoft Word
template file ({\tt naaclhlt2009.dot}) is also available at the same URL. We
strongly recommend the use of these style files, which have been
appropriately tailored for the NAACL HLT 2009 proceedings.
...
Eight pages (8) is the maximum length of the main text of papers for the NAACL HLT 2009
