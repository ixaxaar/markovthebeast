...
can be seen in the Factor Graph of Figure \ref{fig:local2}. Both connect a single  hidden \emph{hasRole} ground atom with two observed \emph{lemma} ground atoms. Note that the ``+'' 
